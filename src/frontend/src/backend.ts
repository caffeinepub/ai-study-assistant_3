...
import type { Message as _Message, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addMessage(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMessage(arg0, arg1, arg2, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getStudyHistory(arg0: Principal): Promise<Array<StudySession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudyHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveStudySession(arg0: Time, arg1: Time, arg2: bigint, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
